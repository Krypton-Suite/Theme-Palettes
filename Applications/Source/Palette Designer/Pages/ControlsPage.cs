...
namespace PaletteDesigner.Pages
{
    public partial class ControlsPage : UserControl
    {
        ...
        {
            // Host panel follows the demo palette like other self-contained pages
            kryptonPanel1.Palette = palette;

            // If any child demo controls should take LocalCustomPalette, add here:
            // Example (none in this minimal extraction):
            // someControl.LocalCustomPalette = palette;
        }
        ...
        private void KryptonNavigatorDesignControls_SelectedPageChanged(object? sender, EventArgs e)
        {
            ...
            // Update headings inside this page (optional local labels already show Disabled/Normal)
            // For external consumers (MainForm) to update its header texts, they can read Navigator.SelectedPage.
        }

        // Convenience exposure for MainForm (optional)
